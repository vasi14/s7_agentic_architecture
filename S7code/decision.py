...
SYSTEM = (
    ...
    "- ANTI-LOOP: If the most-recent entry in RECENT HISTORY shows\n"
    "  search_knowledge returning an empty list (result is blank or '[]'),\n"
    "  do NOT call search_knowledge again. The knowledge base has no indexed\n"
    "  chunks for this topic. Synthesise the answer directly from any\n"
    "  ATTACHED ARTIFACTS content or from the memory/history context already\n"
    "  in front of you.\n"
    "- When ATTACHED ARTIFACTS are present, ALWAYS answer directly from\n"
    "  their text rather than issuing any further tool calls."
)
